...
```bash
tar -tzf mattermost-plugin/dist/focalboard-7.11.2.tar.gz | grep plugin-linux
tar -xOzf mattermost-plugin/dist/focalboard-7.11.2.tar.gz focalboard/plugin.json
