...
| `focalboard-7.11.6-taskid-linux-loong64.tar.gz` | Current preferred task ID build. External surfaces show global ID, card detail shows Board ID, Deleted cards display is fixed, and soft/permanent delete do not release IDs. | Recommended custom build. |
